 ...
 * package, and is not text, and not human-readable. To algorithm and then save a parser
 ...
 * -algorithm trainFilePath [fileRange] -saveToSerializedFile outputFilePath
 * </code></blockquote>
 ...
 * only binary and unary rules. To algorithm and then save a parser
 * as a text data file, use a command line invocation of the form:</p>
 * <blockquote><code>
 * java -mx1500m edu.stanford.nlp.parser.lexparser.LexicalizedParser
 * -algorithm trainFilePath start stop -saveToTextFile outputFilePath
 * </code></blockquote>
