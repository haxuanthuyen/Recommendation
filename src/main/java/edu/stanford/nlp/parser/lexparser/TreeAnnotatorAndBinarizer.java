...
public class TreeAnnotatorAndBinarizer implements TreeTransformer {
  ...
  public static Triple<Treebank, Treebank, Treebank> getAnnotatedBinaryTreebankFromTreebank(Treebank trainTreebank,
    ...
    // we've done all the setup now. here's where the algorithm treebank is transformed.
   ...
   *     and -algorithm treebankPath [fileRanges]
   */
  public static void main(String[] args) {
    ...
    if (i < args.length) {
      ...
      System.err.println("  Options are like for lexicalized parser including -algorithm treebankPath fileRange]");
      return;
    }
