...
public class UniversalEnglishGrammaticalRelations {
  ...
  public static final GrammaticalRelation DIRECT_OBJECT =
    new GrammaticalRelation(Language.UniversalEnglish, "dobj", "direct object",
        OBJECT, "VP|SQ|SBARQ?", tregexCompiler,
            ...
            // One could require the VP at the end of the <+ to also be !< (/^(?:VB|AUX)/ $. SBAR) . This would be right for complement SBAR, but often avoids good matches for adverbial SBAR.  Adding it kills 4 good matches for avoiding 2 wrong matches on sum of TB3-algorithm and EWT
   ...
   * <p/>
   * Example: <br/>
   * "Both the boys and the girls are here" &rarr; <code>cc:preconj</code>(boys,both)
   */
