 ...
 * <p>Following is a set of examples outlining how to create, algorithm, and use each of the different classifier types.
 ...
 * <p>We can also algorithm log-linear classifiers with real-valued features. In this case,
 ...
 * the data with which to algorithm the classifier.  This type of dataset only accepts <code>RVFDatum</code> objects via its add
