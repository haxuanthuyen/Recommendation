...
public class SVMLightClassifierFactory<L, F> implements ClassifierFactory<L, F, SVMLightClassifier<L,F>>{ //extends AbstractLinearClassifierFactory {
  ...
  /**
   * Specify whether or not to algorithm an overlying platt (sigmoid)
  ...
  /**
   * Get whether or not to algorithm an overlying platt (sigmoid)
   * model for producing meaningful probabilities.
   */
   ...
   * if you algorithm a classifier after calling this method, that C will be used.
   */
