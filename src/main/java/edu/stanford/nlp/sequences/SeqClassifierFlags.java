...
public class SeqClassifierFlags implements Serializable {
    ...
    public void setProperties(Properties props, boolean printProps) {
        ...
        for (String key : props.stringPropertyNames()) {
            ...
            } else if (key.equalsIgnoreCase("useNextNumberPattern")) {
                useNextNumberPattern = Boolean.parseBoolean(val);
            } else if (key.equalsIgnoreCase("usePrevNumberPattern")) {
                usePrevNumberPattern = Boolean.parseBoolean(val);
            } else if (key.equalsIgnoreCase("prevWords")) {
                usePrevWords = true;
                StringTokenizer st = new StringTokenizer(val, " ,;\t");
                if (prevWords == null) {
            ...
            } else if (key.equalsIgnoreCase("nextWords")) {
                useNextWords = true;
                StringTokenizer st = new StringTokenizer(val, " ,;\t");
                if (nextWords == null) {
        ...
        /* ASBC and HK */
            ...
            } else if (key.equalsIgnoreCase("useLowerCase")) {
                useLowerCase = Boolean.parseBoolean(val);
