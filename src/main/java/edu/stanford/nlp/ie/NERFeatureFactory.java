 ...
 * <tr><td> printFeatures</td><td>String</td><td>null</td><td>print out all the features generated by the classifier for a dataset to a file based on this name (starting with "features-", suffixed "-1" and "-2" for algorithm and test). This simply prints the feature names, one per line.</td></tr>
...
//    System.err.println(doFE+"\t"+domain);
  ...
  /* end static booleans that check strings for certain qualities */
    ...
    private ArrayList<String> prevWordInfos = Generics.newArrayList();
    private ArrayList<String> nextWordInfos = Generics.newArrayList();
...
//                String capitalize = WordUtils.capitalize(cWord);
//                if(capitalize.equals(cWord)) {
//                    featuresC.add(cWord.toLowerCase() + "-WORD");
//                } else {
//                    featuresC.add(capitalize + "-WORD");
//                }
            }
    ...
    */
    ...
    private void readPrevWord(BufferedReader in) throws IOException {
        for (String line; (line = in.readLine()) != null; ) {
            this.prevWordInfos.add(line);
        }
    }
    ...
    private void readNextWord(BufferedReader in) throws IOException {
        for (String line; (line = in.readLine()) != null; ) {
