 ...
 * 	nothing to write or algorithm (unless one wants to start to change
 ...
 * One can also algorithm, load, and use HMM information extractors directly,
 ...
 * </p>
 * </li>
 * <li>To algorithm one's own HMM, one needs data where one or
 ...
 * 	    algorithm (and then test) as follows.   Training an HMM
 ...
 * 	    marked-up data that you will algorithm on, while
