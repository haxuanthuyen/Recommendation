...
public class HistorySuggestionTest extends TestCase {
    ...
    public void testGroupBySimilarityItem() throws Exception {
        ...
        int itemId = 113699;
        int catId = Resource.catCache.get(itemId);
        ...
        int itemId2 = 123449;
        int catId2 = Resource.catCache.get(itemId);
        ...
        int itemId3 = 115035;
        int catId3 = Resource.catCache.get(itemId);
        ...
        int itemId4 = 113699;
        int catId4 = Resource.catCache.get(itemId);
        ...
        int itemId5 = 116033;
        int catId5 = Resource.catCache.get(itemId);
